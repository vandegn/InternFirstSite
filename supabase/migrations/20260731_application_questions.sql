...
-- ============================================
--
-- !! SUPERSEDED by 20260801_customizable_listings.sql +
--    20260801_fix_question_table_collision.sql, which replace both tables with
--    a typed version (question types, required flags, knockout flagging, file
--    uploads). Kept only as the historical record of what shipped first.
--
--    On a fresh database the later fix migration drops and recreates whatever
--    this file created, so running all three in filename order is correct.
--    Do NOT run this one on its own against an existing database.
--
